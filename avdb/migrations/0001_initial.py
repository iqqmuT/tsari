# Generated by Django 2.0.1 on 2018-03-05 21:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='UnitShipmentStatus',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reporter', models.CharField(max_length=128)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('shipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='avdb.Shipment')),
                ('status_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='avdb.ShipmentStatusType')),
                ('unit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='avdb.Unit')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='shipment',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='avdb.Shipment'),
        ),
        migrations.AddField(
            model_name='itemshipmentstatus',
            name='shipment',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='avdb.Shipment'),
        ),
        migrations.AddField(
            model_name='itemshipmentstatus',
            name='status_type',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='avdb.ShipmentStatusType'),
        ),
        migrations.AddField(
            model_name='item',
            name='item_type',
        ...
        migrations.AddField(
            model_name='equipmentshipmentstatus',
            name='shipment',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='avdb.Shipment'),
        ),
        migrations.AddField(
