# Generated by Django 2.0.1 on 2018-05-02 21:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('contact_person', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='convention_contact_person', to='avdb.ContactPerson')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('contact_person', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='location_contact_person', to='avdb.ContactPerson')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='location_technical_contact', to='avdb.ContactPerson'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='convention',
            name='technical_contact',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='convention_technical_contact', to='avdb.ContactPerson'),
        ),
        migrations.AddField(
